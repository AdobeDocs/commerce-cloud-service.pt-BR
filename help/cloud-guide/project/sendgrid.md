...
>[!TIP]
>
>Você pode encontrar detalhes do SendGrid para sua conta na [Interface do Usuário de Integração](https://cloud.magento.com) e selecionar a guia **Detalhes do Projeto** > **Informações de Hospedagem**.
