---
title: Consultas ao banco de dados de perfil
description: Saiba como habilitar a criação de perfil para entender o impacto das alterações no banco de dados.
...
# Consultas ao banco de dados de perfil
...
1. Exibir o log de consultas.

   ```sql
   SHOW profiles
   ```

1. Limpar a fila de perfis.
